// DlgImageHisto.cpp : implementation file
//
...
DlgImageHisto::DlgImageHisto()
{ m_initok = false;}
/////////////////////////////////////////////////////////////////////////////
DlgImageHisto::~DlgImageHisto()
{ }
/////////////////////////////////////////////////////////////////////////////
BOOL DlgImageHisto::Create(CWnd* pParentWnd, LPCTSTR lpszTemplateName, UINT nStyle, UINT nID)
{
...
/////////////////////////////////////////////////////////////////////////////
BOOL DlgImageHisto::Create(CWnd* pParentWnd, UINT nIDTemplate, UINT nStyle, UINT nID)
{
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(DlgImageHisto, CDialogBar)
	//{{AFX_MSG_MAP(DlgImageHisto)
	ON_WM_PAINT()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// DlgImageHisto message handlers
void DlgImageHisto::InitDlg()
{
	if (m_initok) return;
...
BOOL DlgImageHisto::OnCommand(WPARAM wparam, LPARAM lparam) 
{
...
void DlgImageHisto::OnPaint() 
{
	CPaintDC dc(this); // device context for painting
	
	CTilSysDoc* pDoc = (CTilSysDoc*) ((CMainFrame*)AfxGetMainWnd())->GetActiveFrame()->GetActiveDocument();
	...
	if (pDoc && GetCanvasMgr()->GetCurCanvas()!=NULL) {
