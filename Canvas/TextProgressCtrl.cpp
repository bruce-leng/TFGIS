...
/*/LRESULT CTextProgressCtrl::OnSetText(UINT, LPCTSTR szText)//nlt-cc
{
...
LRESULT CTextProgressCtrl::OnGetText(UINT cchTextMax, LPTSTR szText)//nlt-cc
void CTextProgressCtrl::OnGetText(UINT cchTextMax, LPTSTR szText)
{
